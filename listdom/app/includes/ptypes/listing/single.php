...
class LSD_PTypes_Listing_Single extends LSD_PTypes_Listing
{
    ...
    public function title($claim = true, $favorite = true, $compare = true): string
    {
        ...
        if ($this->entity->is_verified() && is_callable([\LSDPACCLM\Claim::class, 'display_verified']) && \LSDPACCLM\Claim::display_verified()) $output .= ' <span class="lsd-tooltip" data-lsd-tooltip="' . esc_attr__('Verified', 'listdom') . '"><i class="lsd-fe-icon fas fa-check-circle lsd-claimed-icon"></i></span>';
