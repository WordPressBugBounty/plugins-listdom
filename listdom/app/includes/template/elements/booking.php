...
class LSD_Template_Elements_Booking extends LSD_Template
{
    ...
    {
        return esc_html__('Booking Addon', 'listdom');
    }
    ...
    public function controls(): void
    {
        ...
        [
            ...
            'responsive' => true,
            'selectors'  => [
                '{{WRAPPER}} .lsd-template-element-booking' => '{{VALUE}}',
                '{{WRAPPER}} .lsdtb-card-booking' => '{{VALUE}}',
            ],
        ]);
        ...
        [
            ...
            'responsive' => true,
            'selectors'  => [
                '{{WRAPPER}} .lsd-template-element-booking' => 'color:{{VALUE}};',
                '{{WRAPPER}} .lsdtb-card-booking' => 'color:{{VALUE}};',
            ],
        ]);
        ...
        [
            ...
            'responsive' => true,
            'selectors'  => [
                '{{WRAPPER}} .lsd-template-element-booking' => 'background-color:{{VALUE}};',
                '{{WRAPPER}} .lsdtb-card-booking' => 'background-color:{{VALUE}};',
            ],
        ]);
    ...
    public function render(array $args = []): string
    {
        ...
        {
            return LSD_Main::alert(esc_html__('Booking addon should be installed and activated!', 'listdom'), 'warning');
        }
        ...
        $html = '<div class="lsd-template-element-booking lsdtb-card-booking">' . $output . '</div>';

        return apply_filters('lsd_template_element_booking_output', $html, $this, $args);
    }
}
