...
<div class="lsd-dummy-data-wrap">
    <form id="lsd_dummy_data_form">
        <p class="description lsd-mt-4"><?php esc_html_e("Dummy data are pre-made sample listings, search forms, categories, tags, labels, locations, shortcodes, pages, etc. that help you set up the site faster. You'll be able to remove them at any time. Select the items you want to import:", 'listdom'); ?></p>
