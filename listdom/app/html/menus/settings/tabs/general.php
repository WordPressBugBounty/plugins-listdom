...
<div class="lsd-settings-wrap">
    <form id="lsd_settings_form">
            ...
            <div class="lsd-settings-group-wrapper">
                <div class="lsd-settings-fields-wrapper">
                    <div class="lsd-form-row lsd-mb-3">
                        ...
                        <div class="lsd-col-2"><?php esc_html_e('Author Profile', 'listdom'); ?></div>
                        <div class="lsd-col-2"><?php esc_html_e('Listing Card', 'listdom'); ?></div>
                        <div class="lsd-col-2"><?php esc_html_e('Single Listing', 'listdom'); ?></div>
        ...
        <div id="lsd_panel_general_slugs" class="lsd-settings-form-group lsd-tab-content<?php echo $this->subtab === 'slugs' ? ' lsd-tab-content-active' : ''; ?>">
            ...
            <div class="lsd-settings-group-wrapper">
                <div class="lsd-settings-fields-wrapper">
                    <div class="lsd-rounded">
                        <h4 class="lsd-mt-0 lsd-admin-title"><?php esc_html_e('Listings', 'listdom'); ?></h4>
                        <div class="lsd-form-row">
                            <div class="lsd-col-2"><?php echo LSD_Form::label([
                        ...
                        <div class="lsd-form-row">
                            ...
                            <div class="lsd-col-4">
                                <?php echo LSD_Form::textarea([
                                    ...
                                    'value' => $settings['mailchimp_message'] ?: __('Subscribe to our newsletter.', 'listdom'),
                                    'rows' => 5,
                                ]); ?>
                            </div>
                        </div>
