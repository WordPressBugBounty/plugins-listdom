    ...
    <form id="lsd_auth_form">
        <div id="lsd_panel_auth_authentication" class="lsd-auth-form-group lsd-tab-content-active lsd-tab-content">
            ...
            <div class="lsd-settings-group-wrapper">
                <p class="description lsd-my-0"><?php echo sprintf(esc_html__('To use this options you can put %s shortcode into any page.', 'listdom'), '<code>[listdom-auth]</code>'); ?></p>
        ...
        <div id="lsd_panel_auth_login" class="lsd-auth-form-group lsd-tab-content">
            ...
            <div class="lsd-settings-group-wrapper">
                <p class="description lsd-my-0"><?php echo sprintf(esc_html__('To use this options you can put %s shortcode into any page.', 'listdom'), '<code>[listdom-login]</code>'); ?></p>
                <div class="lsd-alert lsd-info lsd-my-0">
        ...
        <div id="lsd_panel_auth_register" class="lsd-auth-form-group lsd-tab-content">
            ...
            <div class="lsd-settings-group-wrapper">
                <p class="description lsd-my-0"><?php echo sprintf(esc_html__('To use this options you can put %s shortcode into any page.', 'listdom'), '<code>[listdom-register]</code>'); ?></p>
                <div class="lsd-alert lsd-info lsd-my-0">
