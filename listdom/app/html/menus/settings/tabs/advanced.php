        ...
        <div id="lsd_panel_advanced_assets-loading" class="lsd-settings-form-group lsd-tab-content<?php echo $this->subtab === 'assets-loading' || !$this->subtab ? ' lsd-tab-content-active' : ''; ?>">
            ...
            <div class="lsd-settings-group-wrapper">
                <div class="lsd-settings-fields-wrapper">
                    <p class="description lsd-my-0"><?php esc_html_e("This feature allows you to optimize your website's performance by controlling where Listdom’s JavaScript and CSS files are loaded. You can choose to load these assets globally or limit them to specific pages where they are required, such as pages that utilize Listdom's features.", 'listdom'); ?></p>
                    <p class="description lsd-my-0"><?php esc_html_e("By reducing asset loading to only the necessary pages, this feature minimizes resource usage and enhances your website's speed, delivering a better experience for your visitors.", 'listdom'); ?></p>
                    ...
                    <div id="lsd_load_assets_per_post_type" class="lsd-mt-2 lsd-row <?php echo $settings['assets']['load'] ? 'lsd-util-hide' : ''; ?>">
                        <div class="lsd-col-12">
                            <p class="description lsd-mt-0 lsd-mb-3"><?php esc_html_e("Please configure each post type. By default, all post types are set to load Listdom's CSS and JS files.", 'listdom'); ?></p>
                    ...
                    <div class="lsd-flex lsd-flex-col lsd-mt-0 lsd-flex-align-items-start lsd-gap-2">
                        <h3 class="lsd-mb-0"><?php esc_html_e('Fontawesome', 'listdom'); ?></h3>
                ...
                <div class="lsd-settings-group-wrapper">
                    <div class="lsd-settings-fields-wrapper">
                        <div class="lsd-box-white">
                            <h4 class="lsd-my-0 lsd-admin-title"><?php esc_html_e('Import', 'listdom'); ?></h4>
                            <p class="description lsd-mb-4"><?php esc_html_e("Simply restore a backup using the exported JSON file.", 'listdom'); ?></p>
                            <p class="lsd-text-red lsd-mt-0 lsd-mb-2"><?php echo sprintf(esc_html__("%s: This will overwrite all existing configurations.", 'listdom'), '<strong class="lsd-text-uppercase">'.esc_html__('Caution', 'listdom').'</strong>'); ?></p>
                            <form id="lsd_import_settings_form" enctype="multipart/form-data" method="post">
                                ...
                                <div class="lsd-text-left lsd-mt-4">
