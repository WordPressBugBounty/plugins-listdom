...
<div class="lsd-settings-wrap">
    <form id="lsd_ai_form">
        <div class="lsd-settings-form-group lsd-box-white lsd-rounded lsd-mt-4 lsd-p-5">
            <h3 class="lsd-my-0"><?php esc_html_e('AI Profiles', 'listdom'); ?></h3>
            ...
            <div class="lsd-ai-profiles lsd-flex lsd-flex-row lsd-flex-content-start lsd-flex-wrap lsd-gap-4">
                <?php foreach($ai['profiles'] as $i => $profile): ?>
                    <div class="lsd-box-white lsd-rounded lsd-p-4 lsd-flex lsd-flex-col lsd-flex-items-stretch lsd-gap-4" id="lsd_settings_ai_profiles_<?php echo esc_attr($i); ?>">
