...
<div class="lsd-metabox">
    ...
    <div class="lsd-approval lsd-mt-4 lsd-mb-4">
        ...
        <div class="lsd-alert lsd-info">
            ...
            <div class="lsd-form-row">
                <div class="lsd-col-2 lsd-text-right"><?php esc_html_e('Name', 'listdom'); ?></div>
    ...
    <div class="lsd-form-group lsd-no-border lsd-mt-0 lsd-mb-0 lsd-form-group-price lsd-listing-module-price">
        <div class="lsd-form-row">
            <div class="lsd-col-2"></div>
            <div class="lsd-col-8"><h3 class="lsd-mt-0"><?php esc_html_e('Price Options', 'listdom'); ?></h3></div>
        </div>
    ...
    <div class="lsd-form-group lsd-no-border lsd-mt-0 lsd-listing-module-contact">
        <div class="lsd-form-row">
            <div class="lsd-col-2"></div>
            <div class="lsd-col-8"><h3 class="lsd-mt-0"><?php esc_html_e('Contact Details', 'listdom'); ?></h3></div>
        </div>
        <div class="lsd-form-row">
            <div class="lsd-col-2 lsd-text-right">
    ...
    <div class="lsd-form-group lsd-no-border lsd-mt-0 lsd-listing-module-remark">
        <div class="lsd-form-row">
            <div class="lsd-col-2"></div>
            <div class="lsd-col-8"><h3 class="lsd-mt-0"><?php esc_html_e('Remark', 'listdom'); ?></h3></div>
        </div>
