...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-10">
        <p class="description"><?php echo sprintf(esc_html__('With the %s skin, you can display directories and listings in a list format. Additionally, you have the option to include a map.', 'listdom'), '<strong>'.esc_html__('List', 'listdom').'</strong>'); ?></p>
    </div>
</div>
<div class="lsd-form-row">
