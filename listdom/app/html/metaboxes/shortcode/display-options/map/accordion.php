...
<div class="lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($accordion['map_provider']) && $accordion['map_provider'] ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_accordion_map_options">
    <div class="lsd-form-row">
        <div class="lsd-col-2"><?php echo LSD_Form::label([
