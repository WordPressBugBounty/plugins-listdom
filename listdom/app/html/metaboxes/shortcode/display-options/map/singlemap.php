    ...
    <div class="lsd-settings-fields-wrapper">
        ...
        <div class="lsd-map-provider-dependency lsd-map-provider-dependency-googlemap lsd-map-provider-dependency-leaflet">
            <div id="lsd_display_options_skin_singlemap_clustering_options" <?php echo ((!isset($singlemap['clustering']) || $singlemap['clustering']) ? '' : 'style="display: none;"'); ?>>
                ...
                <div class="lsd-form-row"><div class="lsd-col-3"><?php echo LSD_Form::label(['class' => 'lsd-fields-label', 'title' => esc_html__('Cluster Color', 'listdom'), 'for' => 'lsd_display_options_skin_singlemap_clustering_color']); ?></div><div class="lsd-col-7"><?php echo LSD_Form::colorpicker(['class' => 'lsd-colorpicker', 'id' => 'lsd_display_options_skin_singlemap_clustering_color', 'name' => 'lsd[display][singlemap][clustering_color]', 'value' => $singlemap['clustering_color'] ?? '#3f51b5', 'default' => '#3f51b5']); ?></div></div>
            </div>
        </div>
    </div>
