...
<div class="lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($grid['map_provider']) && $grid['map_provider'] ? '' : 'lsd-util-hide'; ?>" id="lsd_display_options_skin_grid_map_options">
    <div class="lsd-form-row">
        <div class="lsd-col-2"><?php echo LSD_Form::label([
