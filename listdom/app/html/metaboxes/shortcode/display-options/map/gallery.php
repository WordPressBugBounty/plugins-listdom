...
<div class="lsd-settings-group-wrapper">
    <div class="lsd-settings-fields-wrapper">
        ...
        <div class="lsd_display_options_skin_gallery_map_options lsd-form-group lsd-form-row-map-needed lsd-p-0 lsd-m-0 <?php echo isset($gallery['map_provider']) && $gallery['map_provider'] ? '' : 'lsd-util-hide'; ?>">
            <div class="lsd-form-row">
                <div class="lsd-col-3"><?php echo LSD_Form::label([
                    'class' => 'lsd-fields-label',
            ...
            <div class="lsd-form-row">
                ...
                <div class="lsd-col-7">
                    <?php echo LSD_Form::select([
                        ...
                        'value' => $gallery['mapobject_onclick'] ?? 'infowindow'
                    ]); ?>
