...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-10">
        <p class="description"><?php echo sprintf(esc_html__('Using the %s skin, you can show a slider of the directories and istings in different styles.', 'listdom'), '<strong>'.esc_html__('Slider', 'listdom').'</strong>'); ?></p>
    </div>
</div>
<div class="lsd-form-row">
