...
<div class="lsd-metabox lsd-metabox-map-controls">
    ...
    <ul>
        ...
        <li>
            <label for="lsd_map_control_camera"><?php esc_html_e('Camera Control', 'listdom'); ?></label>
            <select name="lsd[mapcontrols][camera]" id="lsd_map_control_camera">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
            ...
            <p class="description"><?php esc_html_e('Contains both zoom and pan controls.', 'listdom'); ?></p>
        </li>
        <li>
