...
$categories = isset($elements['categories']['enabled']) && $elements['categories']['enabled'] ? $this->replaced_listing_section('categories', 'element', [true, 'text']) : '';
$title = isset($elements['title']['enabled']) && $elements['title']['enabled'] ? $this->replaced_listing_section('title', 'element', [false, false]) : '';
...
$image = isset($elements['image']['enabled']) && $elements['image']['enabled'] ? $this->replaced_listing_section('image') : '';
$gallery = isset($elements['gallery']['enabled']) && $elements['gallery']['enabled'] ? $this->replaced_listing_section('gallery') : '';
$features = isset($elements['features']['enabled']) && $elements['features']['enabled'] ? $this->replaced_listing_section('features') : '';
$content = isset($elements['content']['enabled']) && $elements['content']['enabled'] ? $this->replaced_listing_section('content', 'element', [$this->filtered_content]) : '';
$excerpt = isset($elements['excerpt']['enabled']) && $elements['excerpt']['enabled'] ? $this->replaced_listing_section('excerpt') : '';
$embeds = isset($elements['embed']['enabled']) && $elements['embed']['enabled'] ? $this->replaced_listing_section('embeds', 'rich') : '';
$faq = isset($elements['faq']['enabled']) && $elements['faq']['enabled'] ? $this->faq() : '';
$video = isset($elements['video']['enabled']) && $elements['video']['enabled'] ? $this->replaced_listing_section('featured_video', 'rich') : '';
$price = isset($elements['price']['enabled']) && $elements['price']['enabled'] ? $this->replaced_listing_section('price') : '';
$address = isset($elements['address']['enabled']) && $elements['address']['enabled'] ? $this->replaced_listing_section('address') : '';
$breadcrumb = isset($elements['breadcrumb']['enabled']) && $elements['breadcrumb']['enabled'] ? $this->replaced_listing_section('breadcrumb') : '';
$backbutton = isset($elements['backbutton']['enabled']) && $elements['backbutton']['enabled'] ? $this->backbutton() : '';
$locations = isset($elements['locations']['enabled']) && $elements['locations']['enabled'] ? $this->replaced_listing_section('locations') : '';
$share = isset($elements['share']['enabled']) && $elements['share']['enabled'] ? $this->share() : '';
$related = isset($elements['related']['enabled']) && $elements['related']['enabled'] ? $this->replaced_listing_section('related', 'full') : '';
$remark = isset($elements['remark']['enabled']) && $elements['remark']['enabled'] ? $this->replaced_listing_section('remark') : '';
$tags = isset($elements['tags']['enabled']) && $elements['tags']['enabled'] ? $this->tags() : '';
$contact_info = isset($elements['contact']['enabled']) && $elements['contact']['enabled'] ? $this->replaced_listing_section('contact_info') : '';
$attributes = isset($elements['attributes']['enabled']) && $elements['attributes']['enabled'] ? $this->replaced_listing_section('attributes') : '';
$map = isset($elements['map']['enabled']) && $elements['map']['enabled'] ? $this->replaced_listing_section('map', 'form') : '';
$owner = isset($elements['owner']['enabled']) && $elements['owner']['enabled'] ? $this->replaced_listing_section('owner', 'form') : '';
$abuse = isset($elements['abuse']['enabled']) && $elements['abuse']['enabled'] ? $this->abuse() : '';
$availability = isset($elements['availability']['enabled']) && $elements['availability']['enabled'] ? $this->replaced_listing_section('availability') : '';
