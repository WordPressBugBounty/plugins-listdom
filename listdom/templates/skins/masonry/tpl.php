...
?>
<div class="lsd-skin-wrapper lsd-masonry-view-wrapper <?php echo sanitize_html_class($this->get_bar_class()); ?> <?php echo esc_attr($this->html_class); ?> <?php echo $this->list_view ? 'lsd-masonry-view-list-view' : ''; ?> lsd-style-<?php echo esc_attr($this->style); ?> lsd-font-m" id="lsd_skin<?php echo esc_attr($this->id); ?>">
