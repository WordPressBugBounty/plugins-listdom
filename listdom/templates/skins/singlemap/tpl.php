...
?>
<div class="lsd-skin-wrapper lsd-singlemap-view-wrapper <?php if ($this->sm_shortcode) echo 'lsd-search-position-' . esc_attr($this->sm_position); ?> <?php echo esc_attr($this->html_class); ?>" id="lsd_skin<?php echo esc_attr($this->id); ?>">
        ...
        <?php if ($this->sidebar): ?>
            <div class="lsd-map-sidebar-wrapper <?php echo $this->sidebar_state === 'closed_optional' ? '' : 'lsd-map-sidebar-open'; ?>">
                ...
                <div class="lsd-map-sidebar">
                    <div class="lsd-map-sidebar-search"></div>
                    <div class="lsd-map-sidebar-listings"></div>
                </div>
            </div>
        <?php endif; ?>
