...
<?php $i = 1; foreach($ids as $id): $listing = new LSD_Entity_Listing($id); ?>
	...
	<?php if(2 && ($i % 2) == 1): $open = true; ?>
        <div class="lsd-row">
	<?php endif; ?>

    <div class="lsd-col-<?php echo ($this->default_view == 'list' ? 12 : (12 / 2)); ?>">
	...
	<?php if(2 && ($i % 2) == 0): $open = false; ?>
        </div>
	<?php endif; ?>

	<?php $i++; endforeach; ?>
<?php /** Close the unclosed Row **/ if(2 && $open) echo '</div>';
